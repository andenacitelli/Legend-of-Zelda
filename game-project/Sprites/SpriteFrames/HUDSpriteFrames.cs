...
namespace game_project.Content.Sprites
{
    class HUDSpriteFrames
    {
        ...
        public HUDSpriteFrames()
        {
            ...
            // item selector
            frames.Add("SelectedItemFrameRed", new Rectangle(519, 137, 16, 16));
            frames.Add("SelectedItemFrameBlue", new Rectangle(536, 137, 16, 16));
            ...
            // xp bar parts
            frames.Add("XPBarBlank", new Rectangle(0, 0, 101, 5));
            frames.Add("XPBarFill1", new Rectangle(0, 5, 5, 5));
            frames.Add("XPBarFill2", new Rectangle(0, 5, 5, 5));
            frames.Add("XPBarFill3", new Rectangle(0, 5, 5, 5));
            frames.Add("XPBarFill4", new Rectangle(0, 5, 5, 5));
            frames.Add("XPBarFill5", new Rectangle(0, 5, 5, 5));
            frames.Add("XPBarFill6", new Rectangle(0, 5, 5, 5));
            frames.Add("XPBarFill7", new Rectangle(0, 5, 5, 5));
            frames.Add("XPBarFill8", new Rectangle(0, 5, 5, 5));
            frames.Add("XPBarFill9", new Rectangle(0, 5, 5, 5));
            frames.Add("XPBarFill10", new Rectangle(0, 5, 5, 5));
            frames.Add("XPBarFill11", new Rectangle(0, 5, 5, 5));
            frames.Add("XPBarFill12", new Rectangle(0, 5, 5, 5));
            frames.Add("XPBarFill13", new Rectangle(0, 5, 5, 5));
            frames.Add("XPBarFill14", new Rectangle(0, 5, 5, 5));
            frames.Add("XPBarFill15", new Rectangle(0, 5, 5, 5));
            frames.Add("XPBarFill16", new Rectangle(0, 5, 5, 5));
            frames.Add("XPBarFill17", new Rectangle(0, 5, 5, 5));
            frames.Add("XPBarFill18", new Rectangle(0, 5, 5, 5));
            frames.Add("XPBarFill19", new Rectangle(0, 5, 5, 5));
            frames.Add("XPBarFill20", new Rectangle(0, 5, 6, 5));
        }
    }
}
