...
namespace game_project.Content.Sprites.SpriteFactories
{
    public class HUDSpriteFactory
    {
        ...
        {
            HUDSpriteSheet = content.Load<Texture2D>("NES - The Legend of Zelda - HUD");
            XPBarSheet = content.Load<Texture2D>("XPBar");
        }

        public BasicSprite CreateXPBarBlank()
        {
            List<Rectangle> frames = new List<Rectangle>
            {
                hudSpriteFrames.frames["XPBarBlank"]
            };
            return new BasicSprite(XPBarSheet, frames);
        }

        public BasicSprite CreateXPBarFill(int part)
        {
            List<Rectangle> frames = new List<Rectangle>
            {
                hudSpriteFrames.frames["XPBarFill" + part]
            };
            return new BasicSprite(XPBarSheet, frames);
        }
