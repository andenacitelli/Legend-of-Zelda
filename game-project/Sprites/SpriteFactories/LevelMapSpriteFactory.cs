...
namespace game_project.Content.Sprites.SpriteFactories
{
    public class LevelMapSpriteFactory
    {
        ...
        {
            TileSpriteSheet = content.Load<Texture2D>("NES - The Legend of Zelda - Dungeon Tileset");
        }
        ...
        public BasicSprite CreateTopOpenHalf()
        {
            List<Rectangle> frames = new List<Rectangle>
            {
                tileSpriteFrames.frames["TopOpenHalf"]
            };
            return new BasicSprite(TileSpriteSheet, frames);
        }
        ...
        public BasicSprite CreateTopHoleHalf()
        {
            List<Rectangle> frames = new List<Rectangle>
            {
                tileSpriteFrames.frames["TopHoleHalf"]
            };
            return new BasicSprite(TileSpriteSheet, frames);
        }
        ...
        public BasicSprite CreateLeftOpenHalf()
        {
            List<Rectangle> frames = new List<Rectangle>
            {
                tileSpriteFrames.frames["LeftOpenHalf"]
            };
            return new BasicSprite(TileSpriteSheet, frames);
        }
        ...
        public BasicSprite CreateLeftHoleHalf()
        {
            List<Rectangle> frames = new List<Rectangle>
            {
                tileSpriteFrames.frames["LeftHoleHalf"]
            };
            return new BasicSprite(TileSpriteSheet, frames);
        }
        ...
        public BasicSprite CreateRightOpenHalf()
        {
            List<Rectangle> frames = new List<Rectangle>
            {
                tileSpriteFrames.frames["RightOpenHalf"]
            };
            return new BasicSprite(TileSpriteSheet, frames);
        }
        ...
        public BasicSprite CreateRightHoleHalf()
        {
            List<Rectangle> frames = new List<Rectangle>
            {
                tileSpriteFrames.frames["RightHoleHalf"]
            };
            return new BasicSprite(TileSpriteSheet, frames);
        }
        ...
        public BasicSprite CreateDownOpenHalf()
        {
            List<Rectangle> frames = new List<Rectangle>
            {
                tileSpriteFrames.frames["DownOpenHalf"]
            };
            return new BasicSprite(TileSpriteSheet, frames);
        }
        ...
        public BasicSprite CreateDownHoleHalf()
        {
            List<Rectangle> frames = new List<Rectangle>
            {
                tileSpriteFrames.frames["DownHoleHalf"]
            };
            return new BasicSprite(TileSpriteSheet, frames);
        }
        // tiles
