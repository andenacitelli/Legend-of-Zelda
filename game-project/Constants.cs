...
namespace game_project
{
    ...
    public static class Constants
    {
        ...
        private static readonly List<LayerDepth> orderedDepths = new List<LayerDepth>();
        ...
        // xp
        public const int STARTING_XP = 0;
        ...
        public const int AQUAMENTUS_HEALTH = 300;
        ...
        // Stalfo
        public const int STALFO_HEALTH = 2;
        ...
        public const int WALL_THICKNESS_TOP = 127; // px 
        public const int WALL_TOP_WIDTH = 448; // px 
        public const int WALL_SIDE_WIDTH = 288; // px
        public const int DOOR_OFFSET = 32; // sprite width
        public const int INVIS_BLOCK_OFFSET = 18;
        ...
        public static readonly Vector2 HUD_XPBAR_POSITION = new Vector2(580, 51);
        public static readonly Vector2 HUD_XPBAR_FILLSIZE = new Vector2(20, 0);
