...
namespace game_project.Levels
{
    public class Level
    {
        ...
        // keys
        public bool DropKey { get; set; } = false;
        public Vector2 KeyPos { get; set; }
        ...
        public Level(string csvFilePath)
        {
            ...
            Root.State = EntityStates.Disabled;


            // Add all content to Level
            ...
            Root.State = EntityStates.Playing;

        }

        // Alternate constructor used when we have level data stored somewhere in the codebase (namely randomized levels)
        // We assume we get an array of the result of split (which is another string array)
        public Level(string name, List<string[]> lines)
        {
            var transform = Root.GetComponent<Transform>();
            Root.name = name;
            ...
            // Adjust positioning according to name
        ...
        private Entity HandleCSVRow(string[] line)
        {
            ...
            switch (line[0])
            {
                ...
                case "item":
                    ...
                    break;
                case "enemy":
                    // Console.WriteLine("Creating enemy with parameters " + pos + "," + line[5] + "," + line[6] + "," + line[7]);
        ...
        private void LoadKey(Vector2 pos, int enemies)
        {
            DropKey = true;
            KeyPos = pos;
            numEnemiesLeft = enemies;
        }
            ...
            switch (enemyType)
            {
                ...
                case "stalfo":
                    ...
                    if (itemHeld == "regularkey")
                    {
                        ...
                        keySprite.offsets = new List<Vector2>{ new Vector2(4, 0) };
